package pl.arcsoftware.carcoderepo.config;
...
import static pl.arcsoftware.carcoderepo.config.Constants.HEADER_STRING;
import static pl.arcsoftware.carcoderepo.config.Constants.TOKEN_PREFIX;
